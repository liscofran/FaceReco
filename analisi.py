...
def analisi(
    ...
    while True:
                    ...
                    for detected_face in detected_faces_final:
                        ...
                        if len(dfs) > 0:
                            ...
                            if df.shape[0] > 0:
                                ...
                                # --------------------
                                label = label.split("/")[-1] #rimuovi il path
                                nome = label.rsplit(".", 1)[0] #rimuovi l'estensione
                                found_face = True
        ...
        if (cv2.waitKey(1) & (found_face)) | (cv2.waitKey(1) & 0xFF == ord("q")):
            # kill open cv things
            cap.release()
